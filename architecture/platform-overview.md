...
## Tech Stack Notes (PoC reference)
...
### Mobile PoC
- React Native (or Flutter — to confirm)
- Voice: device microphone + STT API
- TTS: ElevenLabs or similar (coach voice)

> **Note:** PoC tech stack may differ from production choices. Backend architecture not yet specified.

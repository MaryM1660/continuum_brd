...
| Feature | Notes |
|---|---|
| **Dark glassmorphism design system** | Full implementation matching PoC |
...
| **Resume Studio (5 tabs)** | Summary, Structure, XYZ, STARL, Versions |
...
| AI-generated cover letters | Post-MVP (editor exists, generation is post-MVP) |
...
| Story format | STARL (not STAR) | Adds Learning component |
